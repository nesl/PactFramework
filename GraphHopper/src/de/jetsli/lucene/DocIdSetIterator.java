...
public abstract class DocIdSetIterator {
  ...
  /**
   * Returns the following: <ul> <li>-1 or {@link #NO_MORE_DOCS} if {@link #nextDoc()} or {@link
   * #advance(int)} were not called yet. <li>{@link #NO_MORE_DOCS} if the iterator has exhausted.
   * <li>Otherwise it should return the doc ID it is currently on. </ul> <p>
   *
   * @since 2.9
   */
   ...
   * </pre>
   *
   * Some implementations are considerably more efficient than that. <p> <b>NOTE:</b> when <code>
   * target &le; current</code> implementations may opt not to advance beyond their current {@link
   * #docID()}. <p> <b>NOTE:</b> this method may be called with {@link #NO_MORE_DOCS} for
