...
public class DefaultStorage implements Storage {
  ...
  public boolean addEdge(int nodeIdFrom, int nodeIdTo, int flags, CalcDistance callback) {
    ...
    if (fromIndex == osmIdToIndexMap.getNoEntryValue() || toIndex == osmIdToIndexMap
        .getNoEntryValue()) {
      return false;
    }
    ...
    try {
      ...
      if (dist == 0) {
        ...
        logger
            .info(counter + " - distances negative. " + fromIndex + " (" + laf + ", " + lof + ")->"
      ...
      throw new RuntimeException(
          "Problem to add edge! with node " + fromIndex + "->" + toIndex + " osm:" + nodeIdFrom
          + "->" + nodeIdTo, ex);
    }
  }
