 ...
 * is the aim to find the shortest path from P1 to one of the public transport points (M) and to
 * P2.
 *
  ...
  public Path calcShortestPath() {
    ...
    if (pubTransport.isEmpty()) {
      throw new IllegalStateException(
          "You'll need at least one starting point. Set it via addPubTransportPoint");
    }
