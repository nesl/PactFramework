 ...
 *
 * Detailed information is available in this blog post: http://karussell.wordpress.com/2012/05/23/spatial-keys-memory-efficient-geohashes/
 *
...
//            throw new IllegalStateException("allBits needs to be even to use the same amount for lat and lon");
  ...
  public SpatialKeyAlgo setInitialBounds(double minLonInit, double maxLonInit, double minLatInit,
                                         double maxLatInit) {
    minLonI = minLonInit;
    maxLonI = maxLonInit;
    minLatI = minLatInit;
